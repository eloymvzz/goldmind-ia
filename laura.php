...
$filePath = __DIR__ . '/texto-guardado-laura.txt';
$historyPath = __DIR__ . '/consultas-historial-laura.txt';

$configPath = __DIR__ . '/agent-config-laura.php';
$agentConfig = [
    'endpoint' => 'https://l3cdn6wmwi7cgpd2ism7kuik.agents.do-ai.run/api/v1/chat/completions',
    'apiKey' => 'Z7HlbO04OsnbuADd_jmOprb5oeqvFY96',
];
